...
import { Sentiment as PrismaSentiment } from '@prisma/client';
...
import { Search, Trash2, Edit3, Save, X, ChevronLeft, ChevronRight, Loader2, Users, UserCheck, MoreVertical, Plus } from 'lucide-react';
...
export default function MemberList({ teamId, initialMembers = [], initialTotal = 0, onAddMember }: MemberListProps) {
  ...
  const handleCancel = () => {
    setEditingId(null);
    setEditForm({ name: '', email: '', sentiment: 'NEUTRAL' });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search and Stats - Always visible when there are members OR when searching */}
      {(totalMembers > 0 || searchTerm) && (
                      ...
                      {editingId === member.id ? (
                        <Select
                          ...
                          onValueChange={(value) => setEditForm({ 
                            ...editForm, 
                            sentiment: value as PrismaSentiment 
                          })}
                          disabled={isPending}
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="HAPPY" className="font-extralight">
                              <div className="flex items-center gap-2">
                                <span>😊</span>
                                <span>Happy</span>
                              </div>
                            </SelectItem>
                            <SelectItem value="NEUTRAL" className="font-extralight">
                              <div className="flex items-center gap-2">
                                <span>😐</span>
                                <span>Neutral</span>
                              </div>
                            </SelectItem>
                            <SelectItem value="SAD" className="font-extralight">
                              <div className="flex items-center gap-2">
                                <span>😟</span>
                                <span>Sad</span>
                              </div>
